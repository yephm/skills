...
![dragen_pytorch](images\dragen_pytorch.jpg)
...
- 选择**pytorch**作为深度学习的框架，如若了解**tensorflow**，可以联想对比一下两者的异同处，我觉得**tensorflow2**和**pytorch**十分类似
